...
double clamp(double c, double lower, double upper){
...
// phi: azimuth angle
// theta: polar angle
void sh_basis(double phi, double theta, std::vector<double>& coeff, const int& order){
...
void cal_SH_from_envmap(const std::string& filename, std::vector<std::vector<double> >& sh_coeff, const int& order){
